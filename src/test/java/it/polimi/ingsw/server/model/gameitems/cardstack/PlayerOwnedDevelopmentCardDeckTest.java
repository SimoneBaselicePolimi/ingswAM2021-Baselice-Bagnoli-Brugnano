...
class PlayerOwnedDevelopmentCardDeckTest {
     ...
     * Checks the equality between the Development Card Decks generated by pushing all the elements in the same order
     * and the inequality between the ones generated by pushing the elements in a different order.
     */
    @Test
    ...
    void testPeekAll() throws EmptyStackException {
        ...
        assertEquals(testCardsInOrder, cardsList);

        PlayerOwnedDevelopmentCardDeck disorderedDeck = new PlayerOwnedDevelopmentCardDeck(testCardsNotInOrder);
        List<DevelopmentCard> disorderedCardsList = disorderedDeck.peekAll();
        assertEquals(testCardsNotInOrder, disorderedCardsList);
    }
