...
/**
 * This enumeration list all the possible state of Pope's Favor card.
 */
public enum PopeFavorCardState {
	/**
	 * The Pope's Favor card is turned face-up.
	 * It represent on of the two possible configurations of the Pope's Favor cards after a Vatican Report has occurred
	 */
	ACTIVE,
	/**
